...
def main():
    ...
    output_path = './manual_checked_second/subject_smallest'
    ...
    for folder in info:  
        ...
        for file in inputs:
            ...
            #     subjects = rel[0]
            #     objects = rel[2]
            #     key = sorted((subjects, objects))
            #     done.append(key) 

            file_path = os.path.join(folder, file) 
            output_dir = os.path.join(output_path, file) 
            ...
            if len(data['items'])!=1:
                ...
                # for i, item in enumerate(items):
                    ...
                    given_key = sorted((item['object_id'], item['closest_id']))

                    given_key = sorted((item['object_id'], item['closest_id']))
                    if given_key in objects_list:
                        continue
